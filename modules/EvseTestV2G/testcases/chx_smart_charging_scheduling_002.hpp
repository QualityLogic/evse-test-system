...
/**
 * @class DinTestServer
 * @brief A <c>V2GT_TC_CHX_SmartChargingScheduling_002</c> test implementation for the DIN 70121 protocol.
 *
 * <b>Procedure</b>
 *
 * Schedule via EVSE 3-5 non-zero entries in operating range of both EV/EVSE where one entry besides the first is 0A for
 * 1 minute. Start charge and witness power transfer for 2 minutes.
 */
 ...
 * @brief A <c>V2GT_TC_CHX_SmartChargingScheduling_002</c> test implementation for the ISO 15118-2 protocol.
 *
 * <b>Procedure</b>
 *
 * Schedule via EVSE 3-5 non-zero entries in operating range of both EV/EVSE where one entry besides the first is 0A for
