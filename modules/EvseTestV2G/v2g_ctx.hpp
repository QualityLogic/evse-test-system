...
/**
 * @brief Initializes the testing state. This should be called after publishing testing results.
 *
 * @param ctx pointer of type <c>v2g_context</c>. It holds the testing values.
 */
void v2g_ctx_init_testing_values(v2g_context* ctx);
