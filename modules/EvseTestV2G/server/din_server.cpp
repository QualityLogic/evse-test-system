 ...
 */
static void load_din_physical_value(din_PhysicalValueType* const phy_value_dest,
                             const iso2_PhysicalValueType* const phy_value_source) {
...
din_responseCodeType DinServerBase::din_validate_state(const int state, const V2gMsgTypeId current_v2g_msg) {
...
v2g_event DinServerBase::din_validate_response_code(din_responseCodeType* const din_response_code,
                                                    v2g_connection const* conn) {
...
void DinServerBase::publish_DIN_DcEvStatus(v2g_context* ctx, const din_DC_EVStatusType& din_ev_status) {
...
void DinServerBase::publish_din_service_discovery_req(
    v2g_context* ctx, const din_ServiceDiscoveryReqType* const v2g_service_discovery_req) {
    // V2G values that can be published: ServiceCategory, ServiceScope
}

void DinServerBase::publish_din_service_payment_selection_req(
    v2g_context* ctx, const din_ServicePaymentSelectionReqType* const v2g_payment_service_selection_req) {
    // V2G values that can be published: selected_payment_option, SelectedServiceList
}

void DinServerBase::publish_din_charge_parameter_discovery_req(
    v2g_context* ctx, const din_ChargeParameterDiscoveryReqType* const v2g_charge_parameter_discovery_req) {
...
void DinServerBase::publish_din_power_delivery_req(v2g_context* ctx,
                                                   const din_PowerDeliveryReqType* const v2g_power_delivery_req) {
...
void DinServerBase::publish_din_precharge_req(v2g_context* ctx,
                                              const din_PreChargeReqType* const v2g_precharge_req) {
...
void DinServerBase::publish_din_current_demand_req(v2g_context* ctx,
                                                   const din_CurrentDemandReqType* const v2g_current_demand_req) {
...
v2g_event DinServerBase::handle_din_session_setup(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_service_discovery(v2g_connection* conn) {
    ...
    // Terminate charging session if ExternalPayment is disallowed in the scope of testing
...
v2g_event DinServerBase::handle_din_service_payment_selection(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_contract_authentication(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_charge_parameter(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_power_delivery(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_cable_check(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_pre_charge(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_current_demand(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_welding_detection(v2g_connection* conn) {
...
v2g_event DinServerBase::handle_din_session_stop(v2g_connection* conn) {
...
V2gMsgTypeId DinServerBase::find_req_message_type(const v2g_connection* conn) {
    const auto msg_in = conn->exi_in.dinEXIDocument->V2G_Message.Body;
...
v2g_event DinServerBase::handle_request(v2g_connection* conn) {
    ...
    enum V2gMsgTypeId v2g_msg_type = V2G_UNKNOWN_MSG;
    ...
    v2g_msg_type = find_req_message_type(conn);
