...
/**
 * @class DinTestServer
 * @brief A <c>V2GT_TC_CHX_SmartChargingScheduling_001</c> test implementation for the DIN 70121 protocol.
 *
 * <b>Procedure</b>
 *
 * Schedule via EVSE 3-5 non-zero entries in operating range of both EV/EVSE. Start charge and witness power transfer
 * for 2 minutes.
 */
 ...
 * @brief A <c>V2GT_TC_CHX_SmartChargingScheduling_001</c> test implementation for the ISO 15118-2 protocol.
 *
 * <b>Procedure</b>
 *
 * Schedule via EVSE 3-5 non-zero entries in operating range of both EV/EVSE. Start charge and witness power transfer
