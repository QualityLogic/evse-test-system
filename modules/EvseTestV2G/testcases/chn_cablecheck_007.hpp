...
#ifndef EVEREST_TEST_SYSTEM_CHN_CABLECHECK_007_HPP
#define EVEREST_TEST_SYSTEM_CHN_CABLECHECK_007_HPP
...
/**
 * @class TestBase
 * @brief A base class for all <c>TC_EVCC_DC_VTB_CableCheck_007</c> implementations defining common fields.
 */
...
protected:
    bool received_cable_check = false;   // Was CableCheckReq received?
    bool cable_check_failed = false;     // Was CableCheckRes(ResponseCode=FAILED) sent?
...
/**
 * @class DinTestServer
 * @brief A <c>TC_EVCC_DC_VTB_CableCheck_007</c> test implementation for the DIN 70121 protocol.
 */
 ...
 * @brief A <c>TC_EVCC_DC_VTB_CableCheck_007</c> test implementation for the ISO 15118-2 protocol.
 */
...
#endif // EVEREST_TEST_SYSTEM_CHN_CABLECHECK_007_HPP
